...
files = os.listdir("C:/Users/User/Desktop/www/abyss-hub/public/python/contentChecker/tests")
for file in files:
    file = "C:/Users/User/Desktop/www/abyss-hub/public/python/contentChecker/tests/"+file
    plagerised_ratio(fn1, file) 
